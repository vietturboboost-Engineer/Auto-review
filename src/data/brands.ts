...
export const brands: Brand[] = [
  ...
  { slug: 'chevrolet', name: 'Chevrolet', country: 'Hoa Kỳ', color: '#C9A24B', wordmark: 'CHEVROLET' },
  ...
  // --- Anh ---
  { slug: 'land-rover', name: 'Land Rover', country: 'Vương quốc Anh', color: '#0A4D2C', wordmark: 'LAND ROVER' },
  { slug: 'range-rover', name: 'Range Rover', country: 'Vương quốc Anh', color: '#1A1A1A', wordmark: 'RANGE ROVER' },
  { slug: 'jaguar', name: 'Jaguar', country: 'Vương quốc Anh', color: '#1A1A1A', wordmark: 'JAGUAR' },
  { slug: 'bentley', name: 'Bentley', country: 'Vương quốc Anh', color: '#00332E', wordmark: 'BENTLEY' },
  { slug: 'rolls-royce', name: 'Rolls-Royce', country: 'Vương quốc Anh', color: '#680021', wordmark: 'ROLLS-ROYCE' },
  { slug: 'aston-martin', name: 'Aston Martin', country: 'Vương quốc Anh', color: '#00594F', wordmark: 'ASTON MARTIN' },
  { slug: 'lotus', name: 'Lotus', country: 'Vương quốc Anh', color: '#0E5C3A', wordmark: 'LOTUS' },
  { slug: 'mclaren', name: 'McLaren', country: 'Vương quốc Anh', color: '#E66A00', wordmark: 'MCLAREN' },
