...
const carSpecs: Record<string, Spec> = {
  'Toyota Wigo': {
    ...
    pros: [
      ...
      'Nhỏ gọn, dễ đi phố & đỗ xe',
      'Chi phí bảo dưỡng thấp',
    ],
    cons: [
      'Cách âm kém',
      'Tăng tốc yếu khi đầy tải',
      'Nội thất đơn giản',
  ...
  'Toyota Vios': {
    ...
    pros: [
      'Bền bỉ, ít hỏng vặt',
      'Tiết kiệm & giữ giá tốt',
      'Khoang nội thất rộng',
      'Dễ sửa, phụ tùng rẻ',
    ],
    cons: [
      'Cách âm tầm trung',
      'Vô-lăng nhẹ, thiếu cảm giác lái',
      'Thiết kế an toàn',
  ...
  'Toyota Veloz Cross': {
    ...
    pros: [
      '7 chỗ giá hợp lý',
      'Trang bị Toyota Safety Sense',
      'Tiết kiệm nhiên liệu',
      'Gầm cao, thiết kế trẻ trung',
    ],
    cons: [
      'Động cơ hơi yếu khi đầy 7 người',
      'Cách âm chưa tốt',
  ...
  'Toyota Yaris Cross': {
    ...
    pros: [
      'Có bản hybrid rất tiết kiệm',
      'Gầm cao, dáng SUV trẻ',
      'Nhiều công nghệ an toàn',
      'Dễ lái trong phố',
    ],
    cons: [
      'Giá cao trong phân khúc',
      'Khoang hành lý & ghế sau hẹp',
      'Cách âm tầm trung',
      'Bản xăng tăng tốc thường',
    ],
  },
  'Toyota Corolla Cross': {
    ...
    cons: [
      'Giá cao',
      'Một số chi tiết nhựa cứng',
      'Cách âm gầm chưa tốt',
      'Bản xăng hơi ồn khi tăng tốc',
    ],
  },
  'Toyota Innova Cross': {
    ...
    pros: [
      '7 chỗ rộng rãi',
      'Bản hybrid mạnh & tiết kiệm',
      'Nhiều trang bị cao cấp',
      'Gầm cao thực dụng',
    ],
    cons: [
      'Giá cao hơn thế hệ cũ',
      'Chuyển sang dẫn động cầu trước',
      'Thân xe lớn, khó đỗ',
      'Bản hybrid giá khá cao',
    ],
  },
  'Toyota Camry': {
    ...
    cons: [
      'Giá cao',
      'Gầm thấp',
      'Thiên về thoải mái hơn thể thao',
  ...
  'Toyota Fortuner': {
    ...
    pros: [
      'Bền bỉ, gầm cao off-road tốt',
      '7 chỗ rộng rãi',
      'Giữ giá tốt',
      'Bản máy dầu khỏe, kéo tải tốt',
    ],
    cons: [
      'Cách âm tầm trung',
      'Vô-lăng nặng ở tốc độ thấp',
      'Tiêu hao nhiên liệu cao',
      'Lái không êm như xe gầm thấp',
    ],
  },
  'Toyota Land Cruiser': {
...
const maintenance: Milestone[] = [
  {
    ...
    items: [
      'Thay dầu động cơ',
      'Đảo lốp',
      'Kiểm tra phanh, lốp, gạt mưa',
      'Bổ sung nước làm mát/rửa kính',
    ],
  ...
  },
  {
    ...
    items: [
      'Thay dầu + lọc dầu',
      'Thay dầu phanh',
      'Thay lọc nhiên liệu (nếu có)',
      'Kiểm tra/đổi bugi thường',
      'Vệ sinh kim phun',
    ],
  ...
  },
  {
    ...
    items: [
      ...
      'Thay nước làm mát',
      'Thay dầu hộp số',
      'Kiểm tra bơm nước, ắc quy, má phanh, dây đai',
    ],
...
const partsCatalog: CatalogPart[] = [
  // --- Động cơ ---
  {
    name: 'Bơm dầu',
    oem: '15100-xxxxx',
    dealer: '1.800.000 – 3.500.000đ',
    after: '900.000 – 2.000.000đ',
    group: 'Động cơ',
  },
  {
    name: 'Bơm nước (water pump)',
    oem: '16100-xxxxx',
    dealer: '1.200.000 – 2.800.000đ',
    after: '600.000 – 1.500.000đ',
    group: 'Động cơ',
  },
  {
    name: 'Van hằng nhiệt',
    oem: '90916-xxxxx',
    dealer: '350.000 – 800.000đ',
    after: '180.000 – 450.000đ',
    group: 'Động cơ',
  },
  {
    name: 'Dây curoa tổng',
    oem: '90916-02xxx',
    dealer: '400.000 – 1.200.000đ',
    after: '200.000 – 700.000đ',
    group: 'Động cơ',
  },
  {
    name: 'Bộ căng curoa',
    oem: '16620-xxxxx',
    dealer: '900.000 – 2.200.000đ',
    after: '450.000 – 1.300.000đ',
    group: 'Động cơ',
  },
  {
    name: 'Xích cam (timing chain)',
    oem: '13506-xxxxx',
    dealer: '1.500.000 – 3.800.000đ',
    after: '800.000 – 2.200.000đ',
    group: 'Động cơ',
  },
  {
    name: 'Gioăng nắp máy',
    oem: '11115-xxxxx',
    dealer: '700.000 – 2.000.000đ',
    after: '350.000 – 1.200.000đ',
    group: 'Động cơ',
  },
  {
    name: 'Chân máy (engine mount)',
    oem: '12361-xxxxx',
    dealer: '900.000 – 2.500.000đ',
    after: '400.000 – 1.400.000đ',
    group: 'Động cơ',
  },
  {
    name: 'Van PCV',
    oem: '12204-xxxxx',
    dealer: '250.000 – 600.000đ',
    after: '120.000 – 350.000đ',
    group: 'Động cơ',
  },
  {
    name: 'Cuộn đánh lửa (ignition coil)',
    oem: '90919-02xxx',
    dealer: '700.000 – 1.600.000đ/cái',
    after: '350.000 – 900.000đ/cái',
    group: 'Động cơ',
  },
  {
    name: 'Bugi sấy (xe máy dầu)',
    oem: '19850-xxxxx',
    dealer: '400.000 – 900.000đ/cái',
    after: '200.000 – 550.000đ/cái',
    group: 'Động cơ',
  },
  // --- Nhiên liệu & Khí thải ---
  {
    name: 'Bơm xăng',
    oem: '23220-xxxxx',
    dealer: '2.000.000 – 5.000.000đ',
    after: '1.000.000 – 3.000.000đ',
    group: 'Nhiên liệu & Khí thải',
  },
  {
    name: 'Kim phun nhiên liệu',
    oem: '23250-xxxxx',
    dealer: '1.500.000 – 4.000.000đ/cái',
    after: '700.000 – 2.200.000đ/cái',
    group: 'Nhiên liệu & Khí thải',
  },
  {
    name: 'Lọc xăng',
  ...
  {
    name: 'Họng ga điện tử (throttle body)',
    oem: '22030-xxxxx',
    dealer: '3.000.000 – 7.000.000đ',
    after: '1.500.000 – 4.000.000đ',
    group: 'Nhiên liệu & Khí thải',
  },
  {
    name: 'Cảm biến oxy',
    oem: '89465-xxxxx',
    dealer: '1.500.000 – 3.500.000đ',
    after: '700.000 – 2.000.000đ',
    group: 'Nhiên liệu & Khí thải',
  },
  {
    name: 'Cảm biến lưu lượng khí (MAF)',
    oem: '22204-xxxxx',
    dealer: '1.800.000 – 4.000.000đ',
    after: '900.000 – 2.500.000đ',
    group: 'Nhiên liệu & Khí thải',
  },
  {
    name: 'Bầu lọc khí thải (catalytic)',
    oem: '25051-xxxxx',
    dealer: '6.000.000 – 18.000.000đ',
    after: '3.000.000 – 10.000.000đ',
    group: 'Nhiên liệu & Khí thải',
  },
  {
    name: 'Ống xả / bô giảm thanh',
    oem: '17430-xxxxx',
    dealer: '2.000.000 – 6.000.000đ',
    after: '1.000.000 – 3.500.000đ',
    group: 'Nhiên liệu & Khí thải',
  },
  // --- Hệ truyền động ---
  {
    name: 'Bộ ly hợp (clutch kit)',
    oem: '31250-xxxxx',
    dealer: '3.500.000 – 8.000.000đ',
    after: '1.800.000 – 5.000.000đ',
    group: 'Hệ truyền động',
  },
  {
    name: 'Lọc dầu hộp số tự động',
    oem: '35330-xxxxx',
    dealer: '600.000 – 1.500.000đ',
    after: '300.000 – 900.000đ',
    group: 'Hệ truyền động',
  },
  {
    name: 'Trục láp / khớp CV',
    oem: '43410-xxxxx',
    dealer: '2.500.000 – 6.000.000đ',
    after: '1.200.000 – 3.500.000đ',
    group: 'Hệ truyền động',
  },
  {
    name: 'Cao su chân hộp số',
    oem: '12371-xxxxx',
    dealer: '700.000 – 1.800.000đ',
    after: '350.000 – 1.000.000đ',
    group: 'Hệ truyền động',
  },
  {
    name: 'Dầu hộp số CVT/AT (ATF/CVTF)',
    oem: '08886-xxxxx',
    dealer: '300.000 – 600.000đ/lít',
    after: '180.000 – 400.000đ/lít',
    group: 'Hệ truyền động',
  },
  // --- Phanh ---
  {
  ...
  },
  {
    name: 'Đĩa phanh sau',
    oem: '42431-xxxxx',
    dealer: '1.400.000 – 3.200.000đ',
    after: '700.000 – 1.900.000đ',
    group: 'Phanh',
  },
  {
    name: 'Má phanh sau',
    oem: '04466-xxxxx',
    dealer: '700.000 – 1.600.000đ',
    after: '350.000 – 950.000đ',
    group: 'Phanh',
  },
  {
    name: 'Cùm phanh (caliper)',
    oem: '47730-xxxxx',
    dealer: '2.500.000 – 6.000.000đ',
    after: '1.200.000 – 3.500.000đ',
    group: 'Phanh',
  ...
  {
    name: 'Xi lanh phanh tổng',
    oem: '47201-xxxxx',
    dealer: '2.000.000 – 4.500.000đ',
    after: '1.000.000 – 2.800.000đ',
    group: 'Phanh',
  },
  {
    name: 'Dây phanh tay',
    oem: '46410-xxxxx',
    dealer: '400.000 – 900.000đ',
    after: '200.000 – 550.000đ',
    group: 'Phanh',
  },
  // --- Treo & Lái ---
  {
    name: 'Giảm xóc trước',
    oem: '48510-xxxxx',
    dealer: '1.800.000 – 4.500.000đ/cái',
    after: '900.000 – 2.500.000đ/cái',
    group: 'Treo & Lái',
  },
  {
    name: 'Giảm xóc sau',
    oem: '48530-xxxxx',
    dealer: '1.600.000 – 4.000.000đ/cái',
    after: '800.000 – 2.200.000đ/cái',
    group: 'Treo & Lái',
  },
  {
    name: 'Bát bèo giảm xóc',
    oem: '48609-xxxxx',
    dealer: '600.000 – 1.500.000đ',
    after: '300.000 – 900.000đ',
    group: 'Treo & Lái',
  ...
  {
    name: 'Rotuyn trụ đứng (ball joint)',
    oem: '43330-xxxxx',
    dealer: '500.000 – 1.300.000đ',
    after: '250.000 – 800.000đ',
    group: 'Treo & Lái',
  },
  {
    name: 'Rotuyn lái ngoài',
    oem: '45046-xxxxx',
    dealer: '400.000 – 1.000.000đ',
    after: '200.000 – 600.000đ',
    group: 'Treo & Lái',
  },
  {
    name: 'Rotuyn cân bằng',
    oem: '48820-xxxxx',
    dealer: '350.000 – 900.000đ',
    after: '180.000 – 500.000đ',
    group: 'Treo & Lái',
  },
  {
    name: 'Càng A (control arm)',
    oem: '48068-xxxxx',
    dealer: '1.500.000 – 3.500.000đ',
    after: '700.000 – 2.000.000đ',
    group: 'Treo & Lái',
  },
  {
    name: 'Thước lái',
    oem: '44250-xxxxx',
    dealer: '5.000.000 – 12.000.000đ',
    after: '2.500.000 – 7.000.000đ',
    group: 'Treo & Lái',
  },
  {
  ...
  {
    name: 'Bạc đạn bánh xe (wheel bearing)',
    oem: '90369-xxxxx',
    dealer: '700.000 – 2.000.000đ',
    after: '350.000 – 1.200.000đ',
    group: 'Treo & Lái',
  ...
  },
  {
    name: 'Còi xe',
    oem: '86510-xxxxx',
    dealer: '300.000 – 800.000đ',
    after: '150.000 – 450.000đ',
    group: 'Điện & Ắc quy',
  },
  {
    name: 'Mô tơ nâng kính',
    oem: '85710-xxxxx',
    dealer: '900.000 – 2.500.000đ',
    after: '450.000 – 1.400.000đ',
    group: 'Điện & Ắc quy',
  },
  {
    name: 'Ổ khóa điện / đề nổ',
    oem: '89070-xxxxx',
    dealer: '1.500.000 – 4.000.000đ',
    after: '—',
    group: 'Điện & Ắc quy',
  },
  // --- Làm mát & Điều hòa ---
  {
    name: 'Két nước (radiator)',
    oem: '16400-xxxxx',
    dealer: '1.800.000 – 4.500.000đ',
    after: '900.000 – 2.500.000đ',
    group: 'Làm mát & Điều hòa',
  },
  {
    name: 'Quạt két nước',
    oem: '16361-xxxxx',
    dealer: '1.200.000 – 3.000.000đ',
    after: '600.000 – 1.700.000đ',
    group: 'Làm mát & Điều hòa',
  },
  {
    name: 'Ống nước trên / dưới',
    oem: '16571-xxxxx',
    dealer: '250.000 – 700.000đ',
    after: '120.000 – 400.000đ',
    group: 'Làm mát & Điều hòa',
  },
  {
    name: 'Lốc lạnh điều hòa (AC compressor)',
    oem: '88310-xxxxx',
    dealer: '5.000.000 – 14.000.000đ',
    after: '2.500.000 – 8.000.000đ',
    group: 'Làm mát & Điều hòa',
  },
  {
    name: 'Dàn nóng điều hòa (condenser)',
    oem: '88460-xxxxx',
    dealer: '2.000.000 – 5.000.000đ',
    after: '1.000.000 – 3.000.000đ',
    group: 'Làm mát & Điều hòa',
  ...
  {
    name: 'Lưới tản nhiệt (grille)',
    oem: '53111-xxxxx',
    dealer: '1.200.000 – 4.000.000đ',
    after: '600.000 – 2.200.000đ',
    group: 'Thân vỏ & Ngoại thất',
  },
  {
    name: 'Nắp capo',
    oem: '53301-xxxxx',
    dealer: '3.000.000 – 8.000.000đ',
    after: '1.500.000 – 4.500.000đ',
    group: 'Thân vỏ & Ngoại thất',
  },
  {
    name: 'Vè / chắn bùn',
    oem: '53811-xxxxx',
    dealer: '1.000.000 – 3.000.000đ',
    after: '500.000 – 1.700.000đ',
    group: 'Thân vỏ & Ngoại thất',
  },
  {
    name: 'Gương chiếu hậu',
    oem: '87940-xxxxx',
    dealer: '1.500.000 – 4.500.000đ',
    after: '700.000 – 2.500.000đ',
    group: 'Thân vỏ & Ngoại thất',
  },
  {
    name: 'Tay nắm cửa ngoài',
    oem: '69210-xxxxx',
    dealer: '400.000 – 1.200.000đ',
    after: '200.000 – 700.000đ',
    group: 'Thân vỏ & Ngoại thất',
  ...
  // --- Đèn & Gạt mưa ---
  {
    name: 'Đèn pha (headlight)',
    oem: '81150-xxxxx',
    dealer: '2.500.000 – 9.000.000đ',
    after: '1.200.000 – 5.000.000đ',
    group: 'Đèn & Gạt mưa',
  },
  {
    name: 'Đèn hậu',
  ...
  },
  {
    name: 'Đèn sương mù',
    oem: '81210-xxxxx',
    dealer: '600.000 – 1.800.000đ',
    after: '300.000 – 1.000.000đ',
    group: 'Đèn & Gạt mưa',
  },
  {
    name: 'Bóng đèn pha',
    oem: '90981-xxxxx',
    dealer: '200.000 – 800.000đ/cái',
    after: '100.000 – 500.000đ/cái',
    group: 'Đèn & Gạt mưa',
  },
  {
    name: 'Cần gạt mưa',
    oem: '85222-xxxxx',
    dealer: '250.000 – 700.000đ/cái',
    after: '120.000 – 400.000đ/cái',
    group: 'Đèn & Gạt mưa',
  },
  {
    name: 'Mô tơ gạt mưa',
  ...
  },
  {
    name: 'Kính chắn gió',
    oem: '56101-xxxxx',
    dealer: '2.500.000 – 8.000.000đ',
    after: '1.500.000 – 5.000.000đ',
    group: 'Đèn & Gạt mưa',
  },
  // --- Nội thất ---
  {
  ...
  },
  {
    name: 'Thảm sàn',
    oem: '—',
    dealer: '500.000 – 2.500.000đ',
    after: '200.000 – 1.200.000đ',
    group: 'Nội thất',
  },
];
